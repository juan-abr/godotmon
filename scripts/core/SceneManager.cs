...
namespace Game.Core
{
	public partial class SceneManager : Node
	{
		...
		// Saving levels to memory is fine in a smaller game, but shouldn't be used in a larger game.
		// Create an abstract class to help keep track of what is inside of each level (e.g. positioning) in a larger project.
		...
		public override void _Ready()
		{
			...
			Core.Logger.Info("Loading scene manager ...");
		}
		...
		public void Spawn()
		{
			 ...
			 var player = GD.Load<PackedScene>("res://scenes/character/player.tscn").Instantiate<Player>();
